...
if (document.querySelectorAll('.featured-explore-slide').length > 0) {
    tns({
        'container': '.featured-explore-slide',
        'items': 4,
        'gutter': 24,
        'slideBy': 1,
        'autoplay': true,
...
let grid = document.querySelector('.flickr-collection-filter-list');
...
// let flickrTooltip = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))
// let tooltipList = flickrTooltip.map(function (fTTooltip) {
//     return new bootstrap.Tooltip(fTTooltip);
// });

// :: Toast Activation

// let flickrToast = [].slice.call(document.querySelectorAll('.toast'));
// let toastList = flickrToast.map(function (fTToast) {
...
let flickrPopover = [].slice.call(document.querySelectorAll('[data-bs-toggle="popover"]'))
let popoverList = flickrPopover.map(function (ftPopover) {
